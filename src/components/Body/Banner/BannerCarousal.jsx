...
function BannerCarousal() {
    ...
    return (
        <div className="h-1/4 flex flex-col justify-end gap-2 carousal-container">
            ...
            <div className="body-carousal">
                <button className="handle left-handle pb-3" onClick={handlePrevSlide}></button>
                    <div className="slider" style={{
                        ...
                        {results?.map((item) => (
                            <div key={item.id} className="banner-carousal-item" onMouseOver={()=>{fetchGernData(item.id)}}>
