...
function Horror(){
    ...
    useEffect(() => {
        ...
        const url1 = "https://api.themoviedb.org/3/discover/movie?api_key=ef391cfeb6f174409ba6f7cc816802b9&with_genres=27";
    ...
    return (
        <div className="flex flex-col justify-center pt-6 gap-2 newRelease-container">
            <h1 className="newRelease-heading pl-12">Horror Movies</h1>
